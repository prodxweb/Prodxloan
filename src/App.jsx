      ...
      <div className="modal-overlay" onClick={e => e.target===e.currentTarget&&onClose()}>
        <div className="modal-box" style={{textAlign:"center"}}>
          ...
          <p style={{fontSize:14,color:COLORS.gray500,marginBottom:28}}>
            Your preliminary offer is subject to final eligibility checks. For support, email <a href="mailto:contact@prodx.net" style={{color:COLORS.orange,fontWeight:600}}>contact@prodx.net</a>
          </p>
          ...
          <div style={{display:"flex",flexWrap:"wrap",justifyContent:"space-between",gap:32,marginBottom:40}}>
            ...
            <div style={{display:"flex",gap:48,flexWrap:"wrap"}}>
              ...
              <div>
                ...
                <a href="mailto:contact@prodx.net" style={{color:COLORS.orangeLight,fontSize:14,textDecoration:"none"}}>helloprodx@gmail.com</a>
              </div>
            </div>
          </div>
